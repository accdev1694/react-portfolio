...
function App() {
  const [leftIntro, setleftIntro] = useState({
    home: {
    ...
    <Router>
      ...
      <div className="main-container">
        <Routes>
          <Route
            path="/"
            element={<HomePage leftIntro={leftIntro["home"]} />}
          />
          <Route
            path="/my-skills"
            element={<MySkills leftIntro={leftIntro["skills"]} />}
          />
          <Route
            path="/my-projects"
            element={<MyProjects leftIntro={leftIntro["projects"]} />}
          />
          <Route
            path="/contact-me"
            element={<ContactMe leftIntro={leftIntro["contact"]} />}
          />
          <Route
            path="*"
            element={<PageNotFound leftIntro={leftIntro["notFound"]} />}
          />
        </Routes>
      </div>
    </Router>
